# Hypothesis 000033: remove CatBoost auto_class_weights and rely on explicit balanced sample weights only
...
def make_cat_model():
    return dict(
        ...
        # Explicit fold sample weights already encode class balance for this hypothesis.
