...
Feature strategy: Use the feature engineering from source run 2-step132-remote-rerun artifact 20260608T030220-1ee322aa-4 as the hypothesis core, but not its final ensemble logic. Build raw ugriz magnitudes; all pairwise broad color indices such as u-g, u-r, u-i, u-z, g-r, g-i, g-z, r-i, and r-z; band-profile features including spectral slope over ugriz, residual mean absolute value, residual std, second-difference mean/std/absolute mean, magnitude mean/std/range, min/max magnitude, and min/max band labels; redshift features includi…
---
