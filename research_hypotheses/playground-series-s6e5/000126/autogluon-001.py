...
def preprocess(df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["Driver_Stint"] = out["Driver"] + "_" + out["Stint"]

    combo_cols = ["Race_Year", "Driver_Compound", "Driver_Stint"]
    for col in cat_cols + combo_cols:
...
def main() -> None:
    ...
    print(RESULT_MARKER + " " + json.dumps({
        ...
        "research_hypotheses_llm_claimed_used": ["000126"],
        "research_usage_note": "Verified assigned hypothesis 000126.",
    }, sort_keys=True))
