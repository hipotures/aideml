...
def preprocess(df: pd.DataFrame) -> pd.DataFrame:
    ...
    nominations = {
        (2022, "Bahrain Grand Prix"): (1, 2, 3, 0, 0),
        (2022, "Saudi Arabian Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Australian Grand Prix"): (2, 3, 5, 0, 0),
        (2022, "Emilia Romagna Grand Prix"): (2, 3, 4, 1, 0),
        (2022, "Miami Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Spanish Grand Prix"): (1, 2, 3, 0, 0),
        (2022, "Monaco Grand Prix"): (3, 4, 5, 0, 0),
        (2022, "Azerbaijan Grand Prix"): (3, 4, 5, 0, 0),
        (2022, "Canadian Grand Prix"): (3, 4, 5, 0, 0),
        (2022, "British Grand Prix"): (1, 2, 3, 0, 0),
        (2022, "Austrian Grand Prix"): (3, 4, 5, 1, 0),
        (2022, "French Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Hungarian Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Belgian Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Dutch Grand Prix"): (1, 2, 3, 0, 0),
        (2022, "Italian Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Singapore Grand Prix"): (3, 4, 5, 0, 0),
        (2022, "Japanese Grand Prix"): (1, 2, 3, 0, 0),
        (2022, "United States Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Mexico City Grand Prix"): (2, 3, 4, 0, 0),
        (2022, "Sao Paulo Grand Prix"): (2, 3, 4, 1, 0),
        (2022, "Abu Dhabi Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Bahrain Grand Prix"): (1, 2, 3, 0, 0),
        (2023, "Saudi Arabian Grand Prix"): (2, 3, 4, 0, 0),
        (2023, "Australian Grand Prix"): (2, 3, 4, 0, 0),
        (2023, "Azerbaijan Grand Prix"): (3, 4, 5, 1, 0),
        (2023, "Miami Grand Prix"): (2, 3, 4, 0, 0),
        (2023, "Monaco Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Spanish Grand Prix"): (1, 2, 3, 0, 0),
        (2023, "Canadian Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Austrian Grand Prix"): (3, 4, 5, 1, 0),
        (2023, "British Grand Prix"): (1, 2, 3, 0, 0),
        (2023, "Hungarian Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Belgian Grand Prix"): (2, 3, 4, 1, 0),
        (2023, "Dutch Grand Prix"): (1, 2, 3, 0, 0),
        (2023, "Italian Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Singapore Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Japanese Grand Prix"): (1, 2, 3, 0, 0),
        (2023, "Qatar Grand Prix"): (1, 2, 3, 1, 0),
        (2023, "United States Grand Prix"): (2, 3, 4, 1, 0),
        (2023, "Mexico City Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Sao Paulo Grand Prix"): (2, 3, 4, 1, 0),
        (2023, "Las Vegas Grand Prix"): (3, 4, 5, 0, 0),
        (2023, "Abu Dhabi Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Bahrain Grand Prix"): (1, 2, 3, 0, 0),
        (2024, "Saudi Arabian Grand Prix"): (2, 3, 4, 0, 0),
        (2024, "Australian Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Japanese Grand Prix"): (1, 2, 3, 0, 0),
        (2024, "Chinese Grand Prix"): (2, 3, 4, 1, 0),
        (2024, "Miami Grand Prix"): (2, 3, 4, 1, 0),
        (2024, "Emilia Romagna Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Monaco Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Canadian Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Spanish Grand Prix"): (1, 2, 3, 0, 0),
        (2024, "Austrian Grand Prix"): (3, 4, 5, 1, 0),
        (2024, "British Grand Prix"): (1, 2, 3, 0, 0),
        (2024, "Hungarian Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Belgian Grand Prix"): (2, 3, 4, 0, 0),
        (2024, "Dutch Grand Prix"): (1, 2, 3, 0, 0),
        (2024, "Italian Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Azerbaijan Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Singapore Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "United States Grand Prix"): (2, 3, 4, 1, 0),
        (2024, "Mexico City Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Sao Paulo Grand Prix"): (2, 3, 4, 1, 0),
        (2024, "Las Vegas Grand Prix"): (3, 4, 5, 0, 0),
        (2024, "Qatar Grand Prix"): (1, 2, 3, 1, 0),
        (2024, "Abu Dhabi Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Australian Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Chinese Grand Prix"): (2, 3, 4, 1, 0),
        (2025, "Japanese Grand Prix"): (1, 2, 3, 0, 0),
        (2025, "Bahrain Grand Prix"): (1, 2, 3, 0, 0),
        (2025, "Saudi Arabian Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Miami Grand Prix"): (3, 4, 5, 1, 0),
        (2025, "Emilia Romagna Grand Prix"): (4, 5, 6, 0, 0),
        (2025, "Monaco Grand Prix"): (4, 5, 6, 0, 1),
        (2025, "Spanish Grand Prix"): (1, 2, 3, 0, 0),
        (2025, "Canadian Grand Prix"): (4, 5, 6, 0, 0),
        (2025, "Austrian Grand Prix"): (3, 4, 5, 1, 0),
        (2025, "British Grand Prix"): (1, 2, 3, 0, 0),
        (2025, "Belgian Grand Prix"): (2, 3, 4, 1, 0),
        (2025, "Hungarian Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Dutch Grand Prix"): (2, 3, 4, 0, 0),
        (2025, "Italian Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Azerbaijan Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Singapore Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "United States Grand Prix"): (2, 3, 4, 1, 0),
        (2025, "Mexico City Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Sao Paulo Grand Prix"): (2, 3, 4, 1, 0),
        (2025, "Las Vegas Grand Prix"): (3, 4, 5, 0, 0),
        (2025, "Qatar Grand Prix"): (1, 2, 3, 1, 0),
        (2025, "Abu Dhabi Grand Prix"): (3, 4, 5, 0, 0),
    }
    ...
    yr = out["Year"].astype(int)
    race = out["Race"].astype(str)

    hard = np.empty(len(out), dtype=np.float32)
    med = np.empty(len(out), dtype=np.float32)
    soft = np.empty(len(out), dtype=np.float32)
    sprint = np.zeros(len(out), dtype=np.int8)
    monaco_two_stop = np.zeros(len(out), dtype=np.int8)

    for y in sorted(yr.unique()):
        m_y = yr.eq(y).to_numpy()
        dh, dm, ds, dsp, dmono = default_nom.get(int(y), (2, 3, 4, 0, 0))
        hard[m_y], med[m_y], soft[m_y], sprint[m_y], monaco_two_stop[m_y] = (
            dh,
            dm,
            ds,
            dsp,
    ...
    for (y, r), vals in nominations.items():
        m = (yr.eq(y) & race.eq(r)).to_numpy()
        if m.any():
            hard[m], med[m], soft[m], sprint[m], monaco_two_stop[m] = vals

    abs_compound = np.select(
        [
            comp.eq("HARD"),
            comp.eq("MEDIUM"),
            comp.eq("SOFT"),
        ...
        [hard, med, soft, 0.0, -1.0],
        default=med,
    ).astype(np.float32)

    is_dry = comp.isin(["HARD", "MEDIUM", "SOFT"]).to_numpy()
    out["abs_compound_ordinal"] = abs_compound
    out["nominated_hard_ordinal"] = hard
    out["nominated_medium_ordinal"] = med
    out["nominated_soft_ordinal"] = soft
    out["nominated_range"] = (soft - hard).astype(np.float32)
    out["softness_gap_from_hard"] = np.where(is_dry, abs_compound - hard, 0).astype(
        np.float32
    )
    out["softness_gap_to_soft"] = np.where(is_dry, soft - abs_compound, 0).astype(
        np.float32
    )
    out["current_is_softest_of_weekend"] = ((is_dry) & (abs_compound == soft)).astype(
        np.int8
    )
    out["current_is_hardest_of_weekend"] = ((is_dry) & (abs_compound == hard)).astype(
        np.int8
    )
    out["is_wet_or_intermediate"] = (~is_dry).astype(np.int8)
    out["is_sprint_weekend"] = sprint
    out["special_two_stop_rule"] = monaco_two_stop

    dry_past_first_stint = (
        is_dry
        & (out["Stint"].to_numpy() <= 1)
        & (out["RaceProgress"].to_numpy() > 0.55)
    )
    out["mandatory_second_compound_still_unmet"] = dry_past_first_stint.astype(np.int8)
    out["monaco_2025_second_stop_pressure"] = (
        (monaco_two_stop == 1)
        & is_dry
        & (out["Stint"].to_numpy() <= 2)
        & (out["RaceProgress"].to_numpy() > 0.62)
    ).astype(np.int8)
...
def main() -> None:
    ...
    print(RESULT_MARKER + " " + json.dumps({
        ...
        "research_hypotheses_llm_claimed_used": ["000733"],
        "research_usage_note": "Verified assigned hypothesis 000733.",
    }, sort_keys=True))
