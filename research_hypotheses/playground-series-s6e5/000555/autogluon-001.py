...
def preprocess(df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["Lap_per_TyreLife"] = out["LapNumber"] / (out["TyreLife"] + eps)
    ...
    out["Late_Race_TyreLife"] = out["RaceProgress"] * out["TyreLife"]
    ...
    out["Is_Late_Race"] = (out["RaceProgress"] >= 0.70).astype("int8")

    out.attrs["research_hypotheses_llm_claimed_used"] = ["000555"]
    return out
...
def main() -> None:
    ...
    print(RESULT_MARKER + " " + json.dumps({
        ...
        "research_hypotheses_llm_claimed_used": ["000555"],
        "research_usage_note": "Verified assigned hypothesis 000555.",
    }, sort_keys=True))
