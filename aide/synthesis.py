...
def build_synthesis_prompt(context: dict[str, Any]) -> str:
    ...
    if context.get("agent_mode") == AUTOGLUON_PREPROCESS_MODE:
        return (
            ...
            "prediction/test features, including the identifier column. The raw "
            "identifier is available for feature engineering but is ignored by "
            "AutoGluon during model fitting. "
